...
\include{text/algoritmusINS}
\include{text/senzory}
\include{text/hardware}
\include{text/firmware}
\include{text/zpracovaniDat}


\include{text/zaver}

%%% Vložení souboru 'text/literatura' se seznamem zdrojů
%\include{text/bibliografie}
\include{text/bibliografie_Ordered}

%%% Vložení souboru 'text/zkratky' se seznam použitých symbolů, veličin a zkratek
\include{text/zkratky}
%\include{text/zkratkyOrder}
