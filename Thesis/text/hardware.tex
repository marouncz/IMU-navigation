...
Obdobné izolační podložky byly také navrženy a použity ze spodní strany distančních sloupků držící \ac{OLED} displej.
...
Při připojení zařízení ke zdroji pomocí \ac{USB} bylo napájení obnoveno, což je žádoucí. Také byla zkontrolována proudová spotřeba při nabíjení akumulátoru pomocí orientačního \ac{USB} měřicího přístroje, ta byla 751 mA v případě, že je zařízení zapnuté a akumulátor se nabíjí.
