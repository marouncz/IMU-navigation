 ...
 * Return Type  : void
 */
void main_AccelCalSolver(void)
{
  double dv[18];
  double fval[6];
  double x[6];
  /* Initialize function 'AccelCalSolver' input arguments. */
  /* Initialize function input argument 'accel'. */
  /* Call the entry-point 'AccelCalSolver'. */
  argInit_6x3_real_T(dv);
  AccelCalSolver(dv, argInit_real_T(), x, fval);
}
